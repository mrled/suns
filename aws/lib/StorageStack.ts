...
export class StorageStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const bucketName = config.domainName.replace(/\./g, '-');
    this.contentBucket = new s3.Bucket(this, `${config.stackPrefix}ContentBucket`, {
      bucketName: `${bucketName}-content-${this.account}`,
