...
export class MonitoringStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: MonitoringStackProps) {
    ...
    const iteratorAgeAlarm = new cloudwatch.Alarm(this, 'IteratorAgeAlarm', {
      ...
      alarmDescription: 'Alert when DynamoDB Stream processing is falling behind',
    ...
    const streamerErrorAlarm = new cloudwatch.Alarm(this, 'StreamerErrorAlarm', {
    ...
    const webhookNotifyMetric = new logs.MetricFilter(this, 'WebhookNotifyMetric', {
    ...
    const webhookNotifyAlarm = new cloudwatch.Alarm(this, 'WebhookNotifyAlarm', {
    ...
    const streamerNotifyMetric = new logs.MetricFilter(this, 'StreamerNotifyMetric', {
    ...
    const streamerNotifyAlarm = new cloudwatch.Alarm(this, 'StreamerNotifyAlarm', {
    ...
    const webhookThrottleAlarm = new cloudwatch.Alarm(this, 'WebhookThrottleAlarm', {
    ...
    const streamerThrottleAlarm = new cloudwatch.Alarm(this, 'StreamerThrottleAlarm', {
